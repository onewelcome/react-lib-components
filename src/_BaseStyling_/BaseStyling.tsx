...
export const BaseStyling = ({ children, properties = {} }: Props) => {
  const defaultProperties: CSSProperties = {
    colorFocus: "#0085f2",
    colorPrimary: "#041295",
    colorSecondary: "#01041e",
    colorTertiary: "#0096b1",
    defaultLineHeight: "26px",
    buttonBorderRadius: "0.125rem",
    buttonBorderWidth: "0.125rem",
    buttonFontSize: "1rem",
    ...
    snackbarSuccessBackgroundColor: "#178244",
    snackbarErrorBackgroundColor: "#e01e00",
    snackbarBorderRadius: "0.125rem",
    dataGridRowBackgroundColor: "transparent",
    dataGridRowHoverBackgroundColor: "#e6e7f4",
