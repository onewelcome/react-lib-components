...
export type { Props as FormHeaderProps } from "./components/Layout/ContentHeader/ContentHeader";
...
export type { Props as FormTemplateProps } from "./components/Layout/FormPage/FormWithStepper/FormWithStepper";
