      ...
      <BaseModal id="id" onClose={onClose} open={open}>
        ...
        <BaseModalContent>
          <p>
            ...
            efficitur est nec dui auctor blandit a in magna. Nam non diam
            rutrum, ultrices est eu, dignissim magna. Phasellus orci tortor,
            venenatis sed velit sit amet, posuere aliquet eros. Nulla facilisi.{' '}
          </p>
          <p>
            Integer tempor iaculis est, quis lacinia ipsum tincidunt eget. Sed
            quis velit quis erat efficitur dapibus. Proin vitae justo quis
            tellus sagittis cursus. Duis tempus eu nibh eu pretium.
          </p>
        </BaseModalContent>
        <BaseModalActions>
