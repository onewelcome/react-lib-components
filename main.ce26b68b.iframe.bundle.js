...
const BaseStyling = _ref => {
  ...
  const setCSSProperties = CSSPropertiesObject => {
    for (const [key, value] of Object.entries(CSSPropertiesObject)) {
      ...
      baseStylingWrapper.current.style.setProperty(`--${formattedPropertyName}`, value);
    }
  };
  (0,react.useEffect)(() => {
...
var map = {
	...
	"./Notifications/SideSheet/SideSheet.mdx": [
	...
	"./Notifications/SideSheet/SideSheet.stories": [
	...
	"./Notifications/SideSheet/SideSheet.stories.tsx": [
		"./stories/Notifications/SideSheet/SideSheet.stories.tsx",
		961,
		844,
		7229,
	...
	"./hooks/useClickOutside.stories.tsx": [
		"./stories/hooks/useClickOutside.stories.tsx",
		961,
		844,
		9377,
	...
	"./miscellaneous/IdentityProviderButton.mdx": [
	...
	"./miscellaneous/IdentityProviderButton.stories": [
	...
	"./miscellaneous/IdentityProviderButton.stories.tsx": [
		"./stories/miscellaneous/IdentityProviderButton.stories.tsx",
		961,
		844,
		9377,
...
/******/ __webpack_require__.O(0, [3261], () => (__webpack_exec__("./storybook-config-entry.js")));
