...
// EXTERNAL MODULE: ./stories/DataGrid/DataGrid.stories.tsx + 3 modules
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(dist/* Meta */.W8, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), " - mandatory array of ", (0,jsx_runtime.jsx)(_components.code, {
      ...
      state.filters.forEach(filter => {
        shouldBeDiscarded = [...shouldBeDiscarded, !filter.value.reduce((acc, val) => {
          return (
            ...
            operatorPredicateMap[filter.operator](row[filter.column], val) && acc
          );
        }, true)];
      });
