"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[335],{
...
var update = injectStylesIntoStyleTag_default()(ContextMenu_module/* default */.Z, options);
       ...
       /* harmony default export */ const ContextMenu_ContextMenu_module = (ContextMenu_module/* default */.Z && ContextMenu_module/* default */.Z.locals ? ContextMenu_module/* default */.Z.locals : undefined);
...
const defaultOffsetSpacing = (0,helper/* remToPx */.cv)(0.25);
...
const ContextMenuComponent = (_ref, ref) => {
  let {
    ...
    children,
    decorativeElement,
    id = "ID-".concat((0,helper/* generateID */.y)()),
    show = false,
    onShow,
    onClose,
    placement = {
  ...
  (0,useBodyClick/* useBodyClick */.S)(event => {
...
var update = injectStylesIntoStyleTag_default()(ContextMenuItem_module/* default */.Z, options);
       ...
       /* harmony default export */ const ContextMenu_ContextMenuItem_module = (ContextMenuItem_module/* default */.Z && ContextMenuItem_module/* default */.Z.locals ? ContextMenuItem_module/* default */.Z.locals : undefined);
