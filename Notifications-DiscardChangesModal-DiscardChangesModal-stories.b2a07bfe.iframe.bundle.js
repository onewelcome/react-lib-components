"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[8713],{
...
DiscardChangesModal_stories_DiscardChangesModal.play = (0,conditionalPlay/* conditionalPlay */.h)(async _ref => {
  ...
  await (0,testing_library_dist/* waitFor */.fm)(() => {
    (0,jest_dist/* expect */.E)(canvas.getByLabelText("Name")).toHaveValue("Name");
  });
  const input = canvas.getByLabelText("Name");
  await testing_library_dist/* userEvent */.Q4.type(input, "New name");
  const closeButton = canvas.getByText("close modal").closest("button");
  await testing_library_dist/* userEvent */.Q4.click(closeButton);
});
