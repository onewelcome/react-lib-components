...
var _excluded = ["label", "caption", "status", "index", "direction", "disabled", "lastStep"];
function _extends() {
...
var StepComponent = function StepComponent(_ref, ref) {
  ...
  var _useState = (0,react.useState)(28),
    _useState2 = _slicedToArray(_useState, 2),
    stepContentHeight = _useState2[0],
    setStepContentHeight = _useState2[1];
  var _useState3 = (0,react.useState)(28),
    _useState4 = _slicedToArray(_useState3, 2),
    stepContentWidth = _useState4[0],
    setStepContentWidth = _useState4[1];
  direction === "vertical" && additionalClasses.push(Stepper_Step_module["vertical"]);
  var captionRef = (0,react.useRef)(null);
  var labelRef = (0,react.useRef)(null);
  var stepContentRef = (0,react.useRef)(null);
  (0,react.useLayoutEffect)(function () {
    if (captionRef.current && stepContentRef.current && labelRef.current && lastStep) {
      if (direction == "vertical") {
        var capionHeight = captionRef.current.getBoundingClientRect().height;
        var _stepContentHeight = stepContentRef.current.getBoundingClientRect().height;
        setStepContentHeight(capionHeight + _stepContentHeight);
      }
      if (direction == "horizontal") {
        var captionWidth = captionRef.current.getBoundingClientRect().width;
        var labelWidth = labelRef.current.getBoundingClientRect().width;
  ...
  return /*#__PURE__*/react.createElement("button", _extends({}, rest, {
    ...
    style: {
      height: lastStep && direction == "vertical" ? "".concat(stepContentHeight, "px") : "auto",
      width: lastStep && direction == "horizontal" ? "".concat(stepContentWidth, "px") : "auto"
    }
  }, /*#__PURE__*/react.createElement("div", {
    ref: stepContentRef,
    className: Stepper_Step_module["step-content"]
  }, /*#__PURE__*/react.createElement("div", {
    "aria-hidden": true,
    className: Stepper_Step_module["step"]
  }, getStepContent(stepIndex, status)), /*#__PURE__*/react.createElement("span", {
    ref: labelRef,
...
var Stepper_excluded = ["steps", "direction"];
...
var Stepper = function Stepper(_ref) {
  ...
  return /*#__PURE__*/react.createElement("div", Stepper_extends({}, rest, {
    className: "".concat(Stepper_Stepper_module["stepper"], " ").concat(direction === "horizontal" ? Stepper_Stepper_module["horizontal"] : Stepper_Stepper_module["vertical"])
...
try {
    ...
    // @ts-ignore
    Stepper.__docgenInfo = { "description": "", "displayName": "Stepper", "props": { "steps": { "defaultValue": null, "description": "", "name": "steps", "required": true, "type": { "name": "Props[]" } }, "direction": { "defaultValue": { value: "horizontal" }, "description": "", "name": "direction", "required": false, "type": { "name": "enum", "value": [{ "value": "\"horizontal\"" }, { "value": "\"vertical\"" }] } }, "ref": { "defaultValue": null, "description": "", "name": "ref", "required": false, "type": { "name": "((instance: HTMLDivElement | null) => void) | RefObject<HTMLDivElement> | null" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
...
StepperStates.decorators = [function () {
  ...
  }, /*#__PURE__*/react.createElement(Stepper, waitingStateProps), /*#__PURE__*/react.createElement(Stepper, currentStateProps), /*#__PURE__*/react.createElement(Stepper, doneStateProps), /*#__PURE__*/react.createElement(Stepper, errorStateProps)), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement("br", null), /*#__PURE__*/react.createElement("div", {
    style: {
      height: "40vh",
      display: "flex",
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0,dist/* waitFor */.X_)(function () {
            return (0,jest_dist/* expect */.l)(canvas.getAllByText("Step current 1")).toHaveLength(2);
          });
        case 4:
        case "end":
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/*!\n * Copyright 2022 OneWelcome B.V.\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n *//*!\n * Copyright 2022 OneWelcome B.V.\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */.Step-module__sr-only--IchoG{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);border:0}.Step-module__hidden--Qm9BD{display:none}.Step-module__slide-in--LLY4r{animation:Step-module__slide-in--LLY4r .5s forwards}@media(prefers-reduced-motion: reduce){.Step-module__slide-in--LLY4r{animation-duration:.1ms}}.Step-module__slide-out--uVRH8{animation:Step-module__slide-out--uVRH8 .5s forwards}@media(prefers-reduced-motion: reduce){.Step-module__slide-out--uVRH8{animation-duration:.1ms}}@keyframes Step-module__slide-in--LLY4r{0%{transform:translateY(100vh)}100%{transform:translateY(0%)}}@keyframes Step-module__slide-out--uVRH8{0%{transform:translateY(0%)}100%{transform:translateY(100vh)}}.Step-module__step-wrapper--hwJFW{display:flex;flex:1;flex-direction:row;justify-content:center;align-items:center;background-color:rgba(0,0,0,0);border:0;padding:0;margin:0;cursor:pointer}.Step-module__step-wrapper--hwJFW:focus-visible{outline:.125rem solid var(--color-focus);outline-offset:0px;border-radius:var(--focus-border-radius)}.Step-module__step-wrapper--hwJFW .Step-module__step-content--zLA9K{display:flex;justify-content:center;align-items:center}.Step-module__step-wrapper--hwJFW:last-child{flex-grow:0;flex-basis:fit-content}.Step-module__step-wrapper--hwJFW:not(:last-child)::after{content:\"\";margin:0 .5rem;flex-grow:1;min-width:.5rem;border-bottom:2px solid var(--stepper-line-color)}.Step-module__step-wrapper--hwJFW.Step-module__vertical--a_r4r{display:flex;flex-direction:column;flex-grow:1}.Step-module__step-wrapper--hwJFW.Step-module__vertical--a_r4r:last-child{flex-grow:0;flex-basis:fit-content}.Step-module__step-wrapper--hwJFW.Step-module__vertical--a_r4r:not(:last-child)::after{content:\"\";border-bottom:none;margin:.5rem 0 .5rem 1.6875rem;border-left:2px solid var(--stepper-line-color);min-height:.5rem;height:100%;width:100%}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv .Step-module__step-content--zLA9K .Step-module__step--ctubR{color:var(--stepper-default-text-color);color:var(--stepper-waiting-color)}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:hover .Step-module__step-content--zLA9K .Step-module__step--ctubR{border:2px solid var(--stepper-waiting-hover-color);color:var(--stepper-waiting-hover-color)}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:active .Step-module__step-content--zLA9K .Step-module__step--ctubR{border:2px solid var(--stepper-waiting-active-color);color:var(--stepper-waiting-active-color)}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:disabled{cursor:not-allowed}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:disabled .Step-module__step-content--zLA9K .Step-module__step--ctubR{border:2px solid var(--stepper-waiting-disabled-color);color:var(--stepper-waiting-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ{color:var(--stepper-label-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ .Step-module__caption--UzV1j{color:var(--stepper-caption-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__waiting--tLzpv:disabled:not(:last-child)::after{border-color:var(--stepper-line-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN .Step-module__step-content--zLA9K .Step-module__step--ctubR{color:var(--stepper-default-text-color);background-color:var(--stepper-current-color);border-color:var(--stepper-current-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:not(:last-child)::after{border-color:var(--stepper-line-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:hover .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-current-hover-color);background-color:var(--stepper-current-hover-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:active .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-current-active-color);background-color:var(--stepper-current-active-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:disabled{cursor:not-allowed}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:disabled .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-current-disabled-color);background-color:var(--stepper-current-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ{color:var(--stepper-label-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ .Step-module__caption--UzV1j{color:var(--stepper-caption-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN:disabled:not(:last-child)::after{border-color:var(--stepper-line-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN .Step-module__step-content--zLA9K .Step-module__label--jfUnJ{font-weight:700}.Step-module__step-wrapper--hwJFW.Step-module__current--iYhdN .Step-module__step-content--zLA9K .Step-module__label--jfUnJ .Step-module__caption--UzV1j{font-weight:400}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8 .Step-module__step-content--zLA9K .Step-module__step--ctubR{color:var(--stepper-default-text-color);background-color:var(--stepper-done-color);border-color:var(--stepper-done-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:not(:last-child)::after{border-color:var(--stepper-line-bold-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:hover .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-done-hover-color);background-color:var(--stepper-done-hover-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:active .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-done-active-color);background-color:var(--stepper-done-active-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:disabled{cursor:not-allowed}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:disabled .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-done-disabled-color);background-color:var(--stepper-done-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ{color:var(--stepper-label-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ .Step-module__caption--UzV1j{color:var(--stepper-caption-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__done--dkNh8:disabled:not(:last-child)::after{border-color:var(--stepper-line-bold-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir .Step-module__step-content--zLA9K .Step-module__step--ctubR{color:var(--stepper-default-text-color);background-color:var(--stepper-error-color);border-color:var(--stepper-error-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:not(:last-child)::after{border-color:var(--stepper-line-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:hover .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-error-hover-color);background-color:var(--stepper-error-hover-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:active .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-error-active-color);background-color:var(--stepper-error-active-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:disabled{cursor:not-allowed}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:disabled .Step-module__step-content--zLA9K .Step-module__step--ctubR{border-color:var(--stepper-error-disabled-color);background-color:var(--stepper-error-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ{color:var(--stepper-label-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:disabled .Step-module__step-content--zLA9K .Step-module__label--jfUnJ .Step-module__caption--UzV1j{color:var(--stepper-caption-error-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir:disabled:not(:last-child)::after{border-color:var(--stepper-line-disabled-color)}.Step-module__step-wrapper--hwJFW.Step-module__error--Lywir .Step-module__step-content--zLA9K .Step-module__label--jfUnJ .Step-module__caption--UzV1j{color:var(--stepper-caption-error-color)}.Step-module__step--ctubR{flex-shrink:0;box-sizing:border-box;display:flex;justify-content:center;align-items:center;width:1.75rem;height:1.75rem;border:2px solid var(--stepper-waiting-color);border-radius:50%;font-size:var(--font-size-form-label);font-family:var(--font-family);font-weight:700}.Step-module__label--jfUnJ{flex-shrink:0;position:relative;margin-left:.5rem;color:var(--stepper-label-color)}.Step-module__caption--UzV1j{position:absolute;top:1.25rem;left:0;color:var(--stepper-caption-color);font-size:.75rem}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	...
	"step-content": "Step-module__step-content--zLA9K",
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".Stepper-module__stepper--cvKk9{width:100%;display:flex;justify-content:center;align-items:center}.Stepper-module__stepper--cvKk9.Stepper-module__vertical--LxaW9{flex-direction:column;justify-content:flex-start;height:100%;width:auto}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"stepper": "Stepper-module__stepper--cvKk9",
	"vertical": "Stepper-module__vertical--LxaW9"
};
/* harmony default export */ __webpack_exports__.Z = (___CSS_LOADER_EXPORT___);
