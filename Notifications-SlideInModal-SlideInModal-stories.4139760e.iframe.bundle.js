(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[3029],{
...
SlideInModal_stories_SlideInModal.play = (0,conditionalPlay/* conditionalPlay */.h)(async _ref => {
  ...
  await (0,testing_library_dist/* waitFor */.fm)(() => (0,jest_dist/* expect */.E)(canvas.queryByText("Open modal")).not.toBeNull());
  await testing_library_dist/* userEvent */.Q4.click(canvas.getByText("Open modal"));
  (0,jest_dist/* expect */.E)(canvas.getByText("Modal header")).not.toBeNull();
  (0,jest_dist/* expect */.E)(canvas.getByRole("dialog")).toHaveAttribute("aria-modal", "true");
  (0,jest_dist/* expect */.E)(canvas.getByRole("dialog")).toHaveAttribute("aria-hidden", "false");
});
