...
var update = injectStylesIntoStyleTag_default()(ContextMenuDocumentation/* default */.Z, options);
       ...
       /* harmony default export */ const ContextMenu_ContextMenuDocumentation = (ContextMenuDocumentation/* default */.Z && ContextMenuDocumentation/* default */.Z.locals ? ContextMenuDocumentation/* default */.Z.locals : undefined);
...
ContextMenu_stories_ContextMenu.play = (0,conditionalPlay/* conditionalPlay */.B)(async _ref => {
  let {
    canvasElement
  } = _ref;
  ...
  await (0,testing_library_dist/* waitFor */.X_)(() => (0,jest_dist/* expect */.l)(canvas.getAllByRole("menuitem")).toHaveLength(3));
});
...
ContextMenuWithDecorativeElement.play = (0,conditionalPlay/* conditionalPlay */.B)(async _ref2 => {
  let {
    canvasElement
  } = _ref2;
  const canvas = (0,testing_library_dist/* within */.uh)(canvasElement);
  ...
  await (0,testing_library_dist/* waitFor */.X_)(() => (0,jest_dist/* expect */.l)(canvas.getAllByRole("menuitem")).toHaveLength(1));
...
() => {
  return /*#__PURE__*/react.createElement("div", {
    ...
    onClick: (0,dist/* action */.aD)("ContextMenuItem 3 onClick event")
  }, "Example item 3"))), /*#__PURE__*/react.createElement(Tooltip/* Tooltip */.u, {
...
ContextMenuStates.play = (0,conditionalPlay/* conditionalPlay */.B)(async _ref3 => {
  let {
    canvasElement
  } = _ref3;
  const canvas = (0,testing_library_dist/* within */.uh)(canvasElement);
  await (0,testing_library_dist/* waitFor */.X_)(() => (0,jest_dist/* expect */.l)(canvas.getAllByRole("menuitem").length).toBeGreaterThanOrEqual(1));
});
