...
const isToggle = children => !!children?.props?.["data-toggle"];
const CheckboxComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement(FormSelectorWrapper/* FormSelectorWrapper */.p, _extends({}, formSelectorWrapperProps, {
    ...
    className: `${iconClasses.join(" ")} ${Checkbox_Checkbox_module["indeterminate"]}`,
    icon: Icon/* Icons */.F.MinusSquare
  }), checked && !indeterminate && /*#__PURE__*/react.createElement(Icon/* Icon */.I, {
    className: `${iconClasses.join(" ")} ${Checkbox_Checkbox_module["checkmark"]}`,
    icon: Icon/* Icons */.F.CheckmarkSquare
  }), !checked && !indeterminate && /*#__PURE__*/react.createElement(Icon/* Icon */.I, {
    className: `${iconClasses.join(" ")} ${Checkbox_Checkbox_module["square"]}`,
...
const FormSelectorWrapperComponent = (_ref, ref) => {
  ...
  const helperRef = helperProps?.ref ?? /*#__PURE__*/(0,react.createRef)();
  return /*#__PURE__*/react.createElement("div", _extends({}, rest, {
    ref: ref,
    className: `${error ? FormSelectorWrapper_FormSelectorWrapper_module["error"] : ""} ${disabled ? FormSelectorWrapper_FormSelectorWrapper_module["disabled"] : ""} ${className ?? ""}`
  }), /*#__PURE__*/react.createElement("div", containerProps, children), (errorMessage || helperText || helperProps?.children) && /*#__PURE__*/react.createElement(FormHelperText/* FormHelperText */.e, _extends({}, helperProps, {
    ref: helperRef,
    id: `${identifier}`,
    className: `${FormSelectorWrapper_FormSelectorWrapper_module["helper-text"]} ${helperProps?.className ?? ""} ${error ? FormSelectorWrapper_FormSelectorWrapper_module["error"] : ""}`
    ...
    id: errorId
  }, errorMessage) : helperProps?.children || helperText), nestedChildren);
};
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.Checkbox-module__checkbox-wrapper--_6Zjq{position:relative}.Checkbox-module__checkbox-wrapper--_6Zjq+.Checkbox-module__checkbox-wrapper--_6Zjq{margin-top:.75rem}.Checkbox-module__checkbox-container--H4shH{display:flex}.Checkbox-module__checkbox-container--H4shH label{display:inline-block;margin-left:calc(.5*var(--font-size));user-select:none;font-size:var(--font-size-form-label);font-family:var(--font-family);margin-top:.1rem}.Checkbox-module__checkbox-list--WZ3mD{padding:0;margin:1rem 0 0 1.75rem;list-style:none}.Checkbox-module__checkbox-list--WZ3mD li+li{margin-top:.75rem}.Checkbox-module__native-input--sCuK6{position:absolute;top:0;left:0;opacity:0;margin:0;width:var(--font-size-big);height:var(--font-size-big);z-index:2}.Checkbox-module__native-input--sCuK6:checked:not(.Checkbox-module__disabled--ZcHFe)+*{color:var(--color-primary)}.Checkbox-module__native-input--sCuK6:focus-visible+*{border-radius:2px;outline:2px solid var(--color-focus);outline-offset:2px}.Checkbox-module__native-input--sCuK6:active:not(.Checkbox-module__disabled--ZcHFe)+span{background-color:var(--disabled)}.Checkbox-module__native-input--sCuK6.Checkbox-module__error--vVzp_:focus-visible+*{outline-color:var(--color-error)}.Checkbox-module__native-input--sCuK6+span[data-icon=true]:before{display:block;width:var(--font-size-big);height:var(--font-size-big)}.Checkbox-module__native-input--sCuK6:hover+.Checkbox-module__square--njISR:not(.Checkbox-module__disabled--ZcHFe){background-color:var(--checkbox-unchecked-hover-color)}.Checkbox-module__native-input--sCuK6:active+.Checkbox-module__square--njISR:not(.Checkbox-module__disabled--ZcHFe){background-color:var(--checkbox-unchecked-pressed-color)}.Checkbox-module__native-input--sCuK6:hover+.Checkbox-module__checkmark--pFLzT:not(.Checkbox-module__disabled--ZcHFe),.Checkbox-module__native-input--sCuK6:active+.Checkbox-module__indeterminate--YmW4Y:not(.Checkbox-module__disabled--ZcHFe){color:var(--checkbox-checked-hover-color)}.Checkbox-module__native-input--sCuK6:active+.Checkbox-module__checkmark--pFLzT:not(.Checkbox-module__disabled--ZcHFe),.Checkbox-module__native-input--sCuK6:active+.Checkbox-module__indeterminate--YmW4Y:not(.Checkbox-module__disabled--ZcHFe){color:var(--checkbox-checked-pressed-color)}.Checkbox-module__input--GASf2{font-size:var(--font-size-big);width:var(--font-size-big);height:var(--font-size-big);z-index:1}.Checkbox-module__disabled--ZcHFe{cursor:not-allowed}.Checkbox-module__disabled--ZcHFe+span{color:var(--disabled);pointer-events:none}.Checkbox-module__disabled--ZcHFe+label{color:var(--greyed-out)}.Checkbox-module__disabled--ZcHFe+.Checkbox-module__checkmark--pFLzT,.Checkbox-module__disabled--ZcHFe+.Checkbox-module__indeterminate--YmW4Y{color:var(--disabled);background-color:var(--greyed-out);border-radius:2px;outline:1px var(--disabled) solid;outline-offset:-1px}.Checkbox-module__indeterminate--YmW4Y{color:var(--color-primary)}[data-readonlyview=true] .Checkbox-module__checkbox-wrapper--_6Zjq label{border-color:var(--read-only-border-color);color:var(--read-only-text-color);background-color:rgba(0,0,0,0);user-select:text}[data-readonlyview=true] .Checkbox-module__checkbox-wrapper--_6Zjq span{color:var(--color-blue-grey100)}[data-readonlyview=true] .Checkbox-module__checkbox-wrapper--_6Zjq span.Checkbox-module__checkmark--pFLzT{background-color:var(--color-blue-grey900);color:var(--color-white);border-radius:2px}[data-readonlyview=true] .Checkbox-module__checkbox-wrapper--_6Zjq span.Checkbox-module__checkmark--pFLzT:before{outline:1px solid var(--read-only-border-color);border-radius:2px;outline-offset:-1px}[data-readonlyview=true] .Checkbox-module__checkbox-wrapper--_6Zjq input[type=checkbox]{pointer-events:none}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~span:before{color:var(--color-blue-grey100)}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~span.Checkbox-module__checkmark--pFLzT{background-color:var(--color-blue-grey900);color:var(--color-white);border:1px solid var(--read-only-border-color);border-radius:3px}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~span.Checkbox-module__checkmark--pFLzT:before{color:var(--color-white)}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~span[data-icon=true]{color:var(--color-blue-grey100)}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~span[data-icon=true].Checkbox-module__checkmark--pFLzT{background-color:var(--color-blue-grey900);color:var(--color-white);border:0}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~span[data-icon=true].Checkbox-module__checkmark--pFLzT:before{outline:1px solid var(--read-only-border-color);outline-offset:-1px;border-radius:2px}.Checkbox-module__checkbox-container--H4shH input[type=checkbox][data-readonlyview=true]~label{pointer-events:none;user-select:text}`, ""]);
// Exports
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.FormSelectorWrapper-module__error--pT3qn input+span{outline:var(--error) solid 1px;outline-offset:-1px;border-radius:2px;overflow:hidden}.FormSelectorWrapper-module__helper-text--rQDvI{margin-top:.25rem;margin-left:calc(1.75*var(--font-size))}.FormSelectorWrapper-module__error-message--MjwnD{color:var(--error)}.FormSelectorWrapper-module__disabled--kRGk8 input{color:var(--disabled)}.FormSelectorWrapper-module__disabled--kRGk8 input:disabled{cursor:not-allowed}.FormSelectorWrapper-module__disabled--kRGk8 label{cursor:not-allowed}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
