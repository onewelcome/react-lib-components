"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[8426],{
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(dist/* Title */.hE, {}), "\n", (0,jsx_runtime.jsx)(dist/* Subtitle */.Pd, {}), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      children: ["You can define a ", (0,jsx_runtime.jsx)(_components.code, {
        children: "label"
      }), " prop which displays text, followed by an ", (0,jsx_runtime.jsx)(Icon/* Icon */.I, {
...
const Template = args => {
  ...
  return /*#__PURE__*/react.createElement(Tooltip/* Tooltip */.m, args);
};
const Tooltip_stories_Tooltip = Template.bind({});
Tooltip_stories_Tooltip.play = (0,conditionalPlay/* conditionalPlay */.h)(async _ref => {
  var _await$canvas$findByT;
  let {
    canvasElement
  } = _ref;
  const canvas = (0,testing_library_dist/* within */.ux)(canvasElement);
  await (0,testing_library_dist/* waitFor */.fm)(() => (0,jest_dist/* expect */.E)(canvas.queryByText("Example label")).not.toBeNull());
  ...
  await (0,jest_dist/* expect */.E)(infoIcon).not.toBeNull();
  await testing_library_dist/* userEvent */.Q4.hover(infoIcon);
});
