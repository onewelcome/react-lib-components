...
const TabButtonComponent = (_ref, ref) => {
  ...
  const buttonRef = ref || /*#__PURE__*/(0,react.createRef)();
  (0,react.useEffect)(() => {
  ...
  icon && tabButtonClasses.push(Tabs_TabButton_module["has-icon"], Tabs_TabButton_module[`${iconPosition}-icon`]);
...
const TabsComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement("div", Tabs_extends({}, rest, {
    ref: tabsRef,
    className: `${Tabs_Tabs_module["tabs"]} ${className ?? ""}`
...
const Tab = _ref => {
  ...
  return /*#__PURE__*/react.createElement("div", Tab_extends({}, rest, {
    ...
    role: "tabpanel",
    className: `${Tabs_Tab_module["tab"]} ${tabActive ? Tabs_Tab_module["selected"] : ""} ${rest.className ?? ""}`
  }), children);
};
try {
    // @ts-ignore
...
const Template = args => {
  return /*#__PURE__*/react.createElement(Tabs, args, /*#__PURE__*/react.createElement(Tab, Tabs_stories_extends({
    title: "First tab"
  }, args.tabs?.[0]), /*#__PURE__*/react.createElement(Typography/* Typography */.o, {
    variant: "h2"
    ...
    title: "Second tab"
  }, args.tabs?.[1]), /*#__PURE__*/react.createElement(Typography/* Typography */.o, {
    variant: "h2"
    ...
    title: "Third tab"
  }, args.tabs?.[2]), /*#__PURE__*/react.createElement(Typography/* Typography */.o, {
    variant: "h2"
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.TabButton-module__tabbutton--MljDQ{color:var(--tab-text-color);border:0;border-radius:0;font-size:var(--font-size);line-height:var(--default-line-height);margin:0;padding:.5rem 1rem;cursor:pointer;font-family:var(--font-family);background-color:rgba(0,0,0,0);white-space:nowrap;position:relative;font-weight:normal;border-bottom-style:var(--tablist-border-style);border-bottom-width:var(--tablist-border-width);border-bottom-color:var(--tablist-border-color)}.TabButton-module__tabbutton--MljDQ:focus-visible{outline:calc(.125*var(--font-size)) solid var(--color-focus);outline-offset:0;border-radius:var(--focus-border-radius)}.TabButton-module__tabbutton--MljDQ:where(:focus-visible){z-index:1}.TabButton-module__tabbutton--MljDQ:hover{background-color:var(--tab-hover-color)}.TabButton-module__tabbutton--MljDQ:active{background-color:var(--tab-pressed-color)}.TabButton-module__tabbutton--MljDQ.TabButton-module__selected--Jks6A{color:var(--tab-active-text-color)}.TabButton-module__tabbutton--MljDQ.TabButton-module__fluid--DqWuL{flex:1}.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm{gap:calc(.25*var(--font-size));display:inline-flex;align-items:center}.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm i{display:flex}.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm span[data-icon]{display:inline-block;font-size:var(--font-size-big);width:var(--font-size-big)}.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm.TabButton-module__top-icon--vhipm,.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm.TabButton-module__bottom-icon--YOtCF{flex-direction:column}.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm.TabButton-module__left-icon--hfjzD i{order:-1}.TabButton-module__tabbutton--MljDQ.TabButton-module__has-icon--fmnPm.TabButton-module__top-icon--vhipm i{order:-1}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
