"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[2155],{
...
__webpack_require__.d(__webpack_exports__, {
  Radio: () => (/* binding */ Radio_stories_Radio),
  RadioLabelOverflow: () => (/* binding */ RadioLabelOverflow),
  RadioStates: () => (/* binding */ RadioStates),
...
/* harmony default export */ const Elements_Radio = (MDXContent);
...
/* harmony default export */ const Radio_stories = (meta);
const Template = args => /*#__PURE__*/react.createElement(Fieldset/* Fieldset */.L, {
  legend: "Radio button group",
  legendStyle: "body-bold"
}, /*#__PURE__*/react.createElement(Radio/* Radio */.s, _extends({}, args, {
  helperText: "Example helpertext",
  errorMessage: "Example error message",
  value: "example-radio"
}), "Label"));
const Radio_stories_Radio = Template.bind({});
...
RadioStates.decorators = [() => {
  return /*#__PURE__*/react.createElement(react.Fragment, null, radioStates.map((states, index) => /*#__PURE__*/react.createElement(Radio/* Radio */.s, {
    key: index,
    helperText: "Example helper text",
    value: "example-radio",
...
Radio_stories_Radio.parameters = {
  ...Radio_stories_Radio.parameters,
  docs: {
    ...Radio_stories_Radio.parameters?.docs,
    source: {
      ...
      ...Radio_stories_Radio.parameters?.docs?.source
    }
  }
};
...
};;const __namedExportsOrder = ["Radio","RadioLabelOverflow","RadioStates"];
