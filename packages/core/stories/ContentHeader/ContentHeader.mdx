...
The `ContentHeader` component serves as the header for a page and is designed to be flexible and customizable.
...
See the code snippet below that showcases how you can use it.
...
<Canvas of={ContentHeaderStories.ContentHeader} />
