"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[254],{
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[15].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/components/ProgressBar/ProgressBar.module.scss
var ProgressBar_module = __webpack_require__("./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[15].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/components/ProgressBar/ProgressBar.module.scss");
...
var update = injectStylesIntoStyleTag_default()(ProgressBar_module/* default */.A, options);




       /* harmony default export */ const ProgressBar_ProgressBar_module = (ProgressBar_module/* default */.A && ProgressBar_module/* default */.A.locals ? ProgressBar_module/* default */.A.locals : undefined);
...
const ProgressBarComponent = (_ref, ref) => {
  let {
    label,
    caption,
    completed,
  ...
  return /*#__PURE__*/react.createElement("span", _extends({}, rest, {
    ...
    className: ProgressBar_ProgressBar_module["header"]
  }, label && /*#__PURE__*/react.createElement(Typography/* Typography */.o, {
    className: ProgressBar_ProgressBar_module["label"],
    spacing: {
      marginBottom: 2
    },
    variant: "body"
  }, label), percentage !== undefined && /*#__PURE__*/react.createElement(Typography/* Typography */.o, {
    className: ProgressBar_ProgressBar_module["percentage"],
    spacing: {
      marginBottom: 2
    },
    variant: "body"
    ...
    className: "".concat(ProgressBar_ProgressBar_module["bar"], " ").concat(completed ? "" : ProgressBar_ProgressBar_module["loading-state"]),
    style: {
      width: "".concat(completed, "%")
    }
  }), /*#__PURE__*/react.createElement("span", {
    className: "".concat(ProgressBar_ProgressBar_module["bar2"], " ").concat(completed ? "" : ProgressBar_ProgressBar_module["loading-state"])
  })), caption && /*#__PURE__*/react.createElement(Typography/* Typography */.o, {
    className: ProgressBar_ProgressBar_module["caption"],
    spacing: {
      marginBottom: 2
    },
    variant: "sub-text"
...
const ProgressBar = /*#__PURE__*/react.forwardRef(ProgressBarComponent);
try {
    // @ts-ignore
    ProgressBar.displayName = "ProgressBar";
    // @ts-ignore
    ProgressBar.__docgenInfo = { "description": "", "displayName": "ProgressBar", "props": { "caption": { "defaultValue": null, "description": "", "name": "caption", "required": false, "type": { "name": "string" } }, "label": { "defaultValue": null, "description": "", "name": "label", "required": false, "type": { "name": "string" } }, "completed": { "defaultValue": null, "description": "", "name": "completed", "required": false, "type": { "name": "number" } }, "percentage": { "defaultValue": null, "description": "", "name": "percentage", "required": false, "type": { "name": "number" } }, "accessibilityTitle": { "defaultValue": { value: "Progress bar" }, "description": "", "name": "accessibilityTitle", "required": false, "type": { "name": "string" } } } };
    // @ts-ignore
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[15].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/components/ProgressBar/ProgressBar.module.scss":
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.ProgressBar-module__sr-only--rgkxK{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);border:0}.ProgressBar-module__hidden--oaf1R{display:none}.ProgressBar-module__slide-in--CPuGA{animation:ProgressBar-module__slide-in--CPuGA .5s forwards}@media(prefers-reduced-motion: reduce){.ProgressBar-module__slide-in--CPuGA{animation-duration:.1ms}}.ProgressBar-module__slide-out--aeWqg{animation:ProgressBar-module__slide-out--aeWqg .5s forwards}@media(prefers-reduced-motion: reduce){.ProgressBar-module__slide-out--aeWqg{animation-duration:.1ms}}@keyframes ProgressBar-module__slide-in--CPuGA{0%{transform:translateY(100vh)}100%{transform:translateY(0%)}}@keyframes ProgressBar-module__slide-out--aeWqg{0%{transform:translateY(0%)}100%{transform:translateY(100vh)}}.ProgressBar-module__header--ZrXNb{display:flex;justify-content:space-between}.ProgressBar-module__label--v5h5h,.ProgressBar-module__percentage--t504R{font-weight:500}.ProgressBar-module__caption--OcxJq{color:var(--color-blue-grey500);line-height:var(--default-line-height);margin-top:.25rem;display:block}.ProgressBar-module__progress-bar--kq_2y{position:relative;display:block;height:.25rem;width:100%;border-radius:.25rem;background-color:var(--progress-bar-background-color);overflow:hidden}@media(prefers-reduced-motion: reduce){.ProgressBar-module__progress-bar--kq_2y{display:none}}.ProgressBar-module__progress-bar--kq_2y .ProgressBar-module__bar--jv7ix{position:absolute;height:.5rem;border-radius:.25rem;background-color:var(--color-primary500);transition:width .2s ease-in-out}.ProgressBar-module__progress-bar--kq_2y .ProgressBar-module__bar--jv7ix.ProgressBar-module__loading-state--yJxCC{width:33.3%;animation:linear 1.5s ProgressBar-module__slide-in--CPuGA infinite}.ProgressBar-module__progress-bar--kq_2y .ProgressBar-module__bar2--PHs2y{position:absolute;left:-30%;height:.5rem;border-radius:.25rem;background-color:var(--color-primary500);opacity:0}.ProgressBar-module__progress-bar--kq_2y .ProgressBar-module__bar2--PHs2y.ProgressBar-module__loading-state--yJxCC{width:33.3%;animation:linear 1.5s ProgressBar-module__slide-in--CPuGA infinite;animation-delay:.75s}@keyframes ProgressBar-module__slide-in--CPuGA{0%{opacity:1;left:-50%}100%{opacity:1;left:150%}}.ProgressBar-module__placeholder--igo4g{display:none}@media(prefers-reduced-motion: reduce){.ProgressBar-module__placeholder--igo4g{display:unset}}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	...
	"header": `ProgressBar-module__header--ZrXNb`,
	"label": `ProgressBar-module__label--v5h5h`,
	"percentage": `ProgressBar-module__percentage--t504R`,
	"caption": `ProgressBar-module__caption--OcxJq`,
	...
	"bar2": `ProgressBar-module__bar2--PHs2y`,
