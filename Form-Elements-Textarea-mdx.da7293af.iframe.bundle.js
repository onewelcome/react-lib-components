"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[4202],{
...
/* harmony import */ var _Textarea_stories_tsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./stories/Form/Elements/Textarea.stories.tsx");
...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      of: _Textarea_stories_tsx__WEBPACK_IMPORTED_MODULE_4__
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Title */ .hE, {}), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Subtitle */ .Pd, {}), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.p, {
      children: ["The ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "Textarea"
      }), " component is a ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "form"
      }), " component based on the native ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "textarea"
      }), " HTML element. It is wrapped by a ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "div"
      }), " element, which can be configured through the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "wrapperProps"
      }), " prop if necessary."]
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.p, {
      children: ["It has a built-in ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "error"
      }), " state and ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "disabled"
      }), " state. Both are a ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "boolean"
      ...
      children: ["Below you'll find an example of the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "Textarea"
      }), " component. You can toggle states and props through the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.a, {
        href: "#props",
      ...
      of: _Textarea_stories_tsx__WEBPACK_IMPORTED_MODULE_4__.Textarea
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.h1, {
      id: "props",
      children: "Props"
...
/* harmony export */   TextareaInReadOnlyMode: () => (/* binding */ TextareaInReadOnlyMode),
/* harmony export */   __namedExportsOrder: () => (/* binding */ __namedExportsOrder),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var _src_components_Form_Textarea_Textarea__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/components/Form/Textarea/Textarea.tsx");
/* harmony import */ var _Textarea_mdx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./stories/Form/Elements/Textarea.mdx");
/*
...
const meta = {
  ...
  component: _src_components_Form_Textarea_Textarea__WEBPACK_IMPORTED_MODULE_1__/* .Textarea */ .T,
  parameters: {
    docs: {
      page: _Textarea_mdx__WEBPACK_IMPORTED_MODULE_2__["default"]
    }
  },
  argTypes: {
    value: {
...
const Template = args => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_src_components_Form_Textarea_Textarea__WEBPACK_IMPORTED_MODULE_1__/* .Textarea */ .T, args);
const Textarea = Template.bind({});
Textarea.args = {};
const TextareaInReadOnlyMode = Template.bind({});
...
;
const __namedExportsOrder = ["Textarea", "TextareaInReadOnlyMode"];
Textarea.parameters = {
  ...Textarea.parameters,
  docs: {
...
TextareaInReadOnlyMode.parameters = {
  ...TextareaInReadOnlyMode.parameters,
  docs: {
    ...TextareaInReadOnlyMode.parameters?.docs,
    source: {
      originalSource: "args => <TextareaComponent {...args} />",
      ...TextareaInReadOnlyMode.parameters?.docs?.source
    }
  }
};
...
const TextareaComponent = (_ref, ref) => {
  ...
  const renderTextarea = () => {
    if (rest["data-readonlyview"]) {
      return /*#__PURE__*/react.createElement("div", {
        ...
        tabIndex: 0,
        className: `${error ? Textarea_Textarea_module["error"] : ""} ${success ? Textarea_Textarea_module["success"] : ""}`
      }, value);
    }
    return /*#__PURE__*/react.createElement("textarea", _extends({}, rest, {
      ref: ref,
      rows: rows,
      className: `${error ? Textarea_Textarea_module["error"] : ""} ${Textarea_Textarea_module["textarea"]} ${className ?? ""}`,
      disabled: disabled,
      onFocus: event => {
        setFocus(true);
        onFocus?.(event);
  ...
  }), renderTextarea(), icon, /*#__PURE__*/react.createElement("span", {
    className: outlineClasses.join(" ")
  }));
};
const Textarea = (0,withReadOnly/* withReadOnly */.R)(/*#__PURE__*/react.forwardRef(TextareaComponent));
try {
    // @ts-ignore
    Textarea.displayName = "Textarea";
    // @ts-ignore
    Textarea.__docgenInfo = { "description": "", "displayName": "Textarea", "props": { "type": { "defaultValue": null, "description": "", "name": "type", "required": false, "type": { "name": "string" } }, "success": { "defaultValue": { value: "false" }, "description": "", "name": "success", "required": false, "type": { "name": "boolean" } }, "error": { "defaultValue": { value: "false" }, "description": "", "name": "error", "required": false, "type": { "name": "boolean" } }, "helperText": { "defaultValue": null, "description": "", "name": "helperText", "required": false, "type": { "name": "string" } }, "readOnlyView": { "defaultValue": null, "description": "", "name": "readOnlyView", "required": false, "type": { "name": "boolean" } }, "wrapperProps": { "defaultValue": null, "description": "", "name": "wrapperProps", "required": false, "type": { "name": "(Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, \"ref\"> & { ref?: ((instance: HTMLDivElement | null) => void) | ... 2 more ...; })" } } } };
    // @ts-ignore
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.Textarea-module__textarea-wrapper--Ofczb{position:relative;box-sizing:border-box;width:100%}.Textarea-module__textarea-wrapper--Ofczb [data-icon-status=success],.Textarea-module__textarea-wrapper--Ofczb [data-icon-status=error]{position:absolute;right:1.25rem;z-index:1;top:.85rem;font-size:var(--font-size-big)}.Textarea-module__textarea-wrapper--Ofczb [data-icon-status=success]:before,.Textarea-module__textarea-wrapper--Ofczb [data-icon-status=error]:before{font-size:var(--icon-font-big);height:1.25rem;width:1.25rem;display:flex;align-items:center;justify-content:center}.Textarea-module__textarea-wrapper--Ofczb [data-icon-status=success]{color:var(--success)}.Textarea-module__textarea-wrapper--Ofczb [data-icon-status=error]{color:var(--error)}.Textarea-module__textarea-wrapper--Ofczb:hover .Textarea-module__outline--xb6j9{border-color:var(--default);background-color:var(--input-hover-background-color)}.Textarea-module__textarea-wrapper--Ofczb .Textarea-module__outline--xb6j9.Textarea-module__disabled--dJzi8{border-color:var(--disabled);background-color:var(--input-disabled-background-color)}.Textarea-module__textarea-wrapper--Ofczb .Textarea-module__outline--xb6j9.Textarea-module__error--w5n_i{border-color:var(--error)}.Textarea-module__textarea-wrapper--Ofczb .Textarea-module__outline--xb6j9.Textarea-module__focus--_FJAT{border-width:var(--input-border-width-focus)}.Textarea-module__textarea-wrapper--Ofczb .Textarea-module__outline--xb6j9.Textarea-module__focus--_FJAT:not(.Textarea-module__error--w5n_i){border-color:var(--color-focus)}.Textarea-module__textarea-wrapper--Ofczb div[data-readonlyview=true]{min-height:4rem;border:1px solid var(--color-blue-grey100);color:var(--read-only-text-color);background-color:var(--color-white);padding:.5rem .75rem;font-family:var(--font-family);font-size:var(--input-font-size);position:relative;border-radius:.125rem}.Textarea-module__textarea-wrapper--Ofczb div[data-readonlyview=true]~span.Textarea-module__outline--xb6j9{display:none}.Textarea-module__textarea-wrapper--Ofczb div[data-readonlyview=true]:has(~[data-icon-status]){padding-right:2.5rem}.Textarea-module__textarea--6IQAD{padding:calc(.625*var(--font-size)) calc(.5*var(--font-size));box-sizing:border-box;border:0;border-radius:var(--input-border-radius);font-family:var(--font-family);font-size:var(--input-font-size);color:var(--color-blue-grey900);vertical-align:top;resize:vertical;position:relative;background-color:rgba(0,0,0,0);z-index:1;width:calc(100% - var(--input-border-width));margin:var(--input-border-width) 0}.Textarea-module__textarea--6IQAD:disabled{cursor:not-allowed;color:var(--greyed-out)}.Textarea-module__textarea--6IQAD{transition-property:all;transition-duration:.2s;transition-timing-function:ease-in-out}@media(prefers-reduced-motion: reduce){.Textarea-module__textarea--6IQAD{transition-duration:.1ms}}.Textarea-module__textarea--6IQAD:focus:not(:disabled){outline:none}.Textarea-module__textarea--6IQAD:has(~[data-icon-status]){padding-right:2.5rem}.Textarea-module__error--w5n_i{border-color:var(--error)}[data-readonlyview=true] .Textarea-module__outline--xb6j9{border-color:var(--read-only-border-color)}.Textarea-module__outline--xb6j9{pointer-events:none;position:absolute;margin:0;padding:0;inset:0;border-color:var(--light-border-color);border-style:var(--input-border-style);border-width:var(--input-border-width);border-radius:var(--input-border-radius);transition-property:all;transition-duration:.2s;transition-timing-function:ease-in-out}@media(prefers-reduced-motion: reduce){.Textarea-module__outline--xb6j9{transition-duration:.1ms}}`, ""]);
// Exports
