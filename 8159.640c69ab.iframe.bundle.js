"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[8159],{
...
const useSelectPositionList = _ref => {
  ...
  const rePositionList = () => {
    ...
    let position = _Select_interfaces__WEBPACK_IMPORTED_MODULE_1__/* .Position */ .y.Below;

    // Set the position of the select
    if (spaceOnTopOfSelect > spaceOnBottomOfSelect) {
      position = _Select_interfaces__WEBPACK_IMPORTED_MODULE_1__/* .Position */ .y.Above;
    }
