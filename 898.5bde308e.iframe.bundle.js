...
var update = injectStylesIntoStyleTag_default()(ContextMenu_module/* default */.Z, options);
       ...
       /* harmony default export */ var ContextMenu_ContextMenu_module = (ContextMenu_module/* default */.Z && ContextMenu_module/* default.locals */.Z.locals ? ContextMenu_module/* default.locals */.Z.locals : undefined);
...
try {
    ...
    // @ts-ignore
    ContextMenu.__docgenInfo = { "description": "", "displayName": "ContextMenu", "props": { "id": { "defaultValue": null, "description": "", "name": "id", "required": true, "type": { "name": "string" } }, "placement": { "defaultValue": { value: "{ horizontal: \"right\", vertical: \"top\" }" }, "description": "", "name": "placement", "required": false, "type": { "name": "Placement" } }, "offset": { "defaultValue": { value: "{ top: 0, bottom: 0, left: 0, right: 0 }" }, "description": "", "name": "offset", "required": false, "type": { "name": "Offset" } }, "transformOrigin": { "defaultValue": { value: "{ horizontal: \"left\", vertical: \"top\" }" }, "description": "", "name": "transformOrigin", "required": false, "type": { "name": "Placement" } }, "domRoot": { "defaultValue": null, "description": "", "name": "domRoot", "required": false, "type": { "name": "HTMLElement" } }, "trigger": { "defaultValue": null, "description": "", "name": "trigger", "required": true, "type": { "name": "ReactElement<Props, string | JSXElementConstructor<any>> | ReactElement<Props, string | JSXElementConstructor<any>>" } }, "decorativeElement": { "defaultValue": null, "description": "", "name": "decorativeElement", "required": false, "type": { "name": "ReactNode" } }, "debounceAmount": { "defaultValue": null, "description": "", "name": "debounceAmount", "required": false, "type": { "name": "number" } }, "show": { "defaultValue": { value: "false" }, "description": "", "name": "show", "required": false, "type": { "name": "boolean" } }, "onShow": { "defaultValue": null, "description": "", "name": "onShow", "required": false, "type": { "name": "(() => void)" } }, "onClose": { "defaultValue": null, "description": "", "name": "onClose", "required": false, "type": { "name": "(() => void)" } }, "popoverProps": { "defaultValue": null, "description": "", "name": "popoverProps", "required": false, "type": { "name": "Props" } } } };
    // @ts-ignore
...
var update = injectStylesIntoStyleTag_default()(ContextMenuItem_module/* default */.Z, options);
       ...
       /* harmony default export */ var ContextMenu_ContextMenuItem_module = (ContextMenuItem_module/* default */.Z && ContextMenuItem_module/* default.locals */.Z.locals ? ContextMenuItem_module/* default.locals */.Z.locals : undefined);
