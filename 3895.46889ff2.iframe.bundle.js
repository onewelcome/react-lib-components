...
const SideMenu = _ref => {
  ...
  return /*#__PURE__*/react.createElement("ul", {
    ...
    key: item.id,
    role: "none",
    className: "".concat(ContextMenuItem_module/* default */.A["context-menu-item"], " ").concat(DateTimePicker_DateTimePicker_module["aside-menu-item"])
  }, /*#__PURE__*/react.createElement("button", {
    role: "menuitem",
    style: {
      height: "2rem"
...
const DateTimePickerInputSection = _ref => {
  ...
  const setToDate = value => setSelectedDate(prev => ({
    from: prev === null || prev === void 0 ? void 0 : prev.from,
    to: parseDate(value)
  }));
...
const DateTimePicker = _ref => {
  let {
    ...
    translations = {
      errors: {
        dateFormatError: "The format must be ".concat(dateFormat)
      },
  ...
  const [selectedDate, setSelectedDate] = (0,react.useState)({
    from: dateFilterValue !== null && dateFilterValue !== void 0 && dateFilterValue.fromDate ? new Date(dateFilterValue === null || dateFilterValue === void 0 ? void 0 : dateFilterValue.fromDate) : undefined,
    to: dateFilterValue !== null && dateFilterValue !== void 0 && dateFilterValue.toDate ? new Date(dateFilterValue === null || dateFilterValue === void 0 ? void 0 : dateFilterValue.toDate) : undefined
  });
  ...
  (0,react.useEffect)(() => {
    if (dateFilterValue) {
      ...
      if (foundItem !== null && foundItem !== void 0 && foundItem.rangeSeconds && dateFilterValue.type !== DateTimeService/* CUSTOM_DATE_RANGE */.vR) {
  ...
  const saveDateTimePicker = () => {
    var _selectedDate$to$toIS, _selectedDate$to, _selectedDate$from$to, _selectedDate$from;
    onDateFilterValueChange && onDateFilterValueChange({
      toDate: (_selectedDate$to$toIS = (_selectedDate$to = selectedDate.to) === null || _selectedDate$to === void 0 ? void 0 : _selectedDate$to.toISOString()) !== null && _selectedDate$to$toIS !== void 0 ? _selectedDate$to$toIS : "",
      fromDate: (_selectedDate$from$to = (_selectedDate$from = selectedDate.from) === null || _selectedDate$from === void 0 ? void 0 : _selectedDate$from.toISOString()) !== null && _selectedDate$from$to !== void 0 ? _selectedDate$from$to : "",
  ...
  return /*#__PURE__*/react.createElement(Popover/* Popover */.A, {
    ...
    className: "".concat(DateTimePicker_DateTimePicker_module["controls"], " ").concat(toDateError || fromDateError ? DateTimePicker_DateTimePicker_module["has-error"] : "")
  }, /*#__PURE__*/react.createElement("div", {
    ...
    className: "".concat(DateTimePicker_DateTimePicker_module["controls-panel"], " ").concat(DateTimePicker_DateTimePicker_module["set-height"])
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.DateTimePicker-module__popover--sHlZN{display:flex;flex-direction:column;align-items:flex-start;min-width:40rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__content-wrapper--h7OEM{display:flex}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__aside--R1Z9N{display:flex;flex-direction:column;width:9.25rem;border-right:1px solid var(--color-blue-grey100)}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__aside-menu--c0UWJ{margin:.5rem 0;padding:0;white-space:nowrap;list-style:none}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__aside-menu-item--s9MOE{height:2rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__aside-menu-item--s9MOE button{padding:.5rem .75rem;font-size:.75rem;line-height:1rem;text-align:start}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__controls--EWWdh{display:flex;flex-direction:column;gap:2rem;flex-grow:1;padding:2rem 2rem 0 2rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__controls--EWWdh.DateTimePicker-module__has-error--ej2sa{gap:calc(2rem - 15.5681px)}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__controls-panel--OGgIF{display:flex;gap:2rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__controls-panel--OGgIF>*{flex-grow:1}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__controls-panel--OGgIF.DateTimePicker-module__set-height--PiRrR{min-height:17.5rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__actions--dZeSt{display:flex;justify-content:space-between;gap:1rem;flex-grow:1;width:calc(100% - 3rem);border-top:1px solid var(--color-blue-grey100);padding:1rem 1.5rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__input--FjJOa{margin-top:0;max-width:14rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__input--FjJOa label{font-size:.75rem}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__nav--WOXdU{position:absolute}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__next-button--k66tY{position:absolute;left:27.3125rem;top:0}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__prev-button--UFAwB{position:absolute;top:0}.DateTimePicker-module__popover--sHlZN .DateTimePicker-module__month-caption--KvK6x{width:100%;height:2.5rem;margin:0;padding:.75rem 0;font-size:.75rem;font-weight:500;line-height:1rem;text-align:center}.DateTimePicker-module__error-message--Jqdyo{font-size:.625rem}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
