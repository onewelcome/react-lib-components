...
var BaseModalComponent = function BaseModalComponent(_ref, ref) {
  ...
  (0,react.useEffect)(function () {
    if (open) {
      ...
      (_wrappingDivRef$curre = wrappingDivRef.current) === null || _wrappingDivRef$curre === void 0 ? void 0 : _wrappingDivRef$curre.focus();
    }
  }, [open]);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/*!\n * Copyright 2022 OneWelcome B.V.\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n *//*!\n * Copyright 2022 OneWelcome B.V.\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n *//*!\n * Copyright 2022 OneWelcome B.V.\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */.BaseModal-module__sr-only--_ncLY{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);border:0}.BaseModal-module__hidden--G6XdL{display:none}.BaseModal-module__slide-in--jEsyw{animation:BaseModal-module__slide-in--jEsyw .5s forwards}@media(prefers-reduced-motion: reduce){.BaseModal-module__slide-in--jEsyw{animation-duration:.1ms}}.BaseModal-module__slide-out--teWnm{animation:BaseModal-module__slide-out--teWnm .5s forwards}@media(prefers-reduced-motion: reduce){.BaseModal-module__slide-out--teWnm{animation-duration:.1ms}}@keyframes BaseModal-module__slide-in--jEsyw{0%{transform:translateY(100vh)}100%{transform:translateY(0%)}}@keyframes BaseModal-module__slide-out--teWnm{0%{transform:translateY(0%)}100%{transform:translateY(100vh)}}.BaseModal-module__modal--_ZoAQ{position:fixed;z-index:10;top:0;left:0;height:100vh;width:100vw;visibility:hidden;display:flex;align-items:flex-start;justify-content:center}.BaseModal-module__modal--_ZoAQ .BaseModal-module__backdrop--Q_rWu{content:\"\";position:absolute;width:100%;height:100%;left:0;top:0;background-color:rgba(0,0,0,0);transition-property:background-color;transition-duration:.5s;transition-timing-function:ease}@media(prefers-reduced-motion: reduce){.BaseModal-module__modal--_ZoAQ .BaseModal-module__backdrop--Q_rWu{transition-duration:.1ms}}.BaseModal-module__modal--_ZoAQ.BaseModal-module__visible--sEHI4{visibility:visible}.BaseModal-module__modal--_ZoAQ.BaseModal-module__visible--sEHI4 .BaseModal-module__backdrop--Q_rWu{background-color:var(--modal-backdrop-color);opacity:.75}.BaseModal-module__container--B8h9b{margin-top:3.125rem;background-color:var(--modal-background-color);z-index:11;width:calc(100% - 2rem);display:flex;flex-direction:column}@media only screen and (min-width: 50em){.BaseModal-module__container--B8h9b{min-width:480px;width:min-content;height:auto;max-height:calc(90% - 3.125rem);border-radius:2px;box-shadow:0 30px 50px var(--modal-shadow-color)}}", ""]);
// Exports
