...
const ProgressBarComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement("span", _extends({}, rest, {
    ...
    className: `${ProgressBar_ProgressBar_module["bar"]} ${completed ? "" : ProgressBar_ProgressBar_module["loading-state"]}`,
    style: {
      width: `${completed}%`
    }
  }), /*#__PURE__*/react.createElement("span", {
    className: `${ProgressBar_ProgressBar_module["bar2"]} ${completed ? "" : ProgressBar_ProgressBar_module["loading-state"]}`
