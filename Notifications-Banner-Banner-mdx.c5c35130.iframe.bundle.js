...
const BannerComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement("section", _extends({}, rest, {
    ...
    role: ariaRole,
    className: `${Banner_Banner_module["banner"]} ${Banner_Banner_module[type]}`
