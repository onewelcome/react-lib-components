"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[1041],{
...
function addMilliseconds(date, amount, options) {
  return (0,constructFrom/* constructFrom */.w)(options?.in || date, +(0,toDate/* toDate */.a)(date) + amount);
}
...
function setWeek(date, week, options) {
  ...
  return (0,toDate/* toDate */.a)(date_, options?.in);
}
...
function getISODay(date, options) {
  const day = (0,toDate/* toDate */.a)(date, options?.in).getDay();
  return day === 0 ? 7 : day;
}
...
var getTimezoneOffsetInMilliseconds = __webpack_require__("./node_modules/date-fns/_lib/getTimezoneOffsetInMilliseconds.js");
...
function parse(dateStr, formatStr, referenceDate, options) {
  const invalidDate = () => (0,constructFrom/* constructFrom */.w)(options?.in || referenceDate, NaN);
  ...
  if (!formatStr)
    return dateStr ? invalidDate() : (0,toDate/* toDate */.a)(referenceDate, options?.in);
  ...
  let date = (0,toDate/* toDate */.a)(referenceDate, options?.in);
