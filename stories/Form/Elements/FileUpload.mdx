import { Canvas, Title, Subtitle, Subheading, ArgTypes, Story } from "@storybook/blocks";
...
<ul>
  ...
  <li>
    <strong>maxFileSize</strong>: If given, the file selector will show an error for the files
    selected or dropped
  </li>
  <li>
...
<Canvas>
  <Story of={FileUploadStories.FileUploadComponent} />
</Canvas>

# Example that uses server interaction as well:

<Canvas>
  <Story of={FileUploadStories.FileUploadComponentWithServerInteraction} />
</Canvas>
