...
<DocsStory id="components-inputs-fileupload--file-upload-component" />

# Example that uses server interaction as well:

<DocsStory id="components-inputs-fileupload--file-upload-component-with-server-interaction" />
