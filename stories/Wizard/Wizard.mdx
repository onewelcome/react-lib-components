...
The `Wizard` component is used to give the user some sort of indication of how far they are in a process. This could, for example, be a form with many different steps.

In order to configure the `Wizard` correctly, there's a few different components you will use.
...
This function will allow you to listen to the event that the user goes to a next or previous step. This way, you can create your own
...
Wizard actions with allow you to render different buttons based on what step the user is on. The following buttons will be rendered:
...
A function that will get executed as soon as the user clicks on the Cancel button. You can use this to, for example, close the modal that the `Wizard` is in.

### `onNext`

A function that will get executed when the user clicks on the Next button. Use this to update the active step state you've created to go to the next step.

### `onPrevious`

A function that will get executed when the user clicks on the Previous button. Use this to update the active step state you've created to go to the previous step.

### `onSaveAndClose`

A function that will get executed when the user clicks on the Save & Close button. Gets the current step number as an argument.
...
<Canvas>
  <Story id="stories-form-wizard-wizard--basic-wizard" />
</Canvas>

Wizard within a modal:

<Canvas>
  <Story id="stories-form-wizard-wizard--wizard-in-modal" />
</Canvas>
