...
import WarningSnackbarDocumentation from "./WarningSnackbar.mdx";
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      page: WarningSnackbarDocumentation
    }
  }
};
...
const AppContent = () => {
  ...
  useEffect(() => {
    enqueueWarningSnackbar(undefined, "Main message of the snackbar", {
