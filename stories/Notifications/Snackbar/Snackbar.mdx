...
- title (`string`): The title displayed at the top of the snackbar.
...
Will allow you to easily and quickly create an error `Snackbar`. The `variant` prop is already set to be `error`.
...
<Canvas>
  <Story id="stories-notifications-snackbar--snackbar" />
</Canvas>
