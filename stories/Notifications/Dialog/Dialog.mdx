...
<Canvas>
  <Story id="stories-notifications-dialog--right-aligned-action-dialog" />
</Canvas>
...
<Canvas>
  <Story id="stories-notifications-dialog--left-aligned-action-dialog" />
</Canvas>
...
<Canvas>
  <Story id="stories-notifications-dialog--single-action-dialog" />
</Canvas>
...
<Canvas>
  <Story id="stories-notifications-dialog--nested-dialogs" />
</Canvas>
