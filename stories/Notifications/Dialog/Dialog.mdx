...
<DocsStory id="stories-notifications-dialog--right-aligned-action-dialog" />
...
<DocsStory id="stories-notifications-dialog--left-aligned-action-dialog" />
...
<DocsStory id="stories-notifications-dialog--single-action-dialog" />
...
<DocsStory id="stories-notifications-dialog--nested-dialogs" />
