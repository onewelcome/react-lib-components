...
<Canvas>
  <Story id="components-data-display-datagrid--simple-data-grid" />
</Canvas>
...
<Canvas>
  <Story id="components-data-display-datagrid--hide-column-data-grid" />
</Canvas>
...
<Canvas>
  <Story id="components-data-display-datagrid--index-data-grid" />
</Canvas>
...
<Canvas>
  <Story id="components-data-display-datagrid--skeleton-loading-animation-data-grid" />
</Canvas>
...
<Canvas>
  <Story id="components-data-display-datagrid--empty-data-grid" />
</Canvas>
...
<Canvas>
  <Story id="components-data-display-datagrid--actions-data-grid" />
</Canvas>
...
<Canvas>
  <Story id="components-data-display-datagrid--pagination-data-grid" />
</Canvas>

# Full example

<Canvas>
  <Story id="components-data-display-datagrid--data-grid" />
</Canvas>
