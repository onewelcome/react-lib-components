...
This project provides React components built according to the [UI Component Library design](https://xd.adobe.com/view/1f7161d7-5ade-4e54-bb3d-6e4aa3a1d1a0-4a22/grid/).
...
For more information about the `BaseStyling` component, [you can read the docs here.](/docs/components-layout-basestyling--page)
