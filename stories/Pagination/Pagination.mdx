...
The pagination component is used to make content readable through separating it in different chunks (read: pages). You as a developer are responsible for requesting the right content for the page that's active and for keeping track of the current page and page size.
...
<Canvas>
  <Story id="stories-ui-pagination--pagination" />
</Canvas>
