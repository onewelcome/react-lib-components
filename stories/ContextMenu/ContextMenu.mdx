...
<Canvas>
  <Story of={ContextMenuStories.ContextMenu} />
</Canvas>
...
<Canvas>
  <Story of={ContextMenuStories.ContextMenuWithDecorativeElement} />
</Canvas>
...
<Canvas>
  <Story of={ContextMenuStories.ControlledContextMenu} />
</Canvas>

The following code example shows how one can [controll ContextMenu's active state by value](/story/components-navigation-contextmenu--context-menu-with-decorative-element).
