...
<DocsStory id="components-navigation-contextmenu--context-menu" />
...
<DocsStory id="stories-ui-contextmenu--context-menu-with-decorative-element" />

The following code example shows how one can [add a decorative element to ContextMenu](/story/stories-ui-contextmenu--context-menu-with-decorative-element).
