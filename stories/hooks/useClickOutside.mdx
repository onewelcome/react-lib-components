...
The `useClickOutside` function accepts three arguments:
...
- dependingStateVariable - Whenever our component gets rendered and rerendered, we want to prevent that our `window.addEventListener` gets added more than once. After all,
