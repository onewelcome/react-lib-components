...
This hook is used to place items somewhere on the viewport relative to a certain element. In order to use this hook you will need to check the following:
...
The `usePosition` hook takes 5 arguments, and also gives back 5 variables [you can extract using destructuring assignment](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment).
