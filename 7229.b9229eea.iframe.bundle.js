(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[7229],{
...
const IconComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement(Component, _extends({}, rest, {
    ...
    "data-icon": true,
    "aria-hidden": "true",
    className: `${Icon_Icon_module["icon"]} ${Icon_Icon_module["icon-" + icon]} ${className ? className : ""}`
  }));
};
...
___CSS_LOADER_EXPORT___.locals = {
	...
	"icon-arrow-left": `Icon-module__icon-arrow-left--njlKW`,
...
"use strict";
module.exports = __webpack_require__.p + "static/media/icomoon.dd4cac2c.eot";
...
"use strict";
module.exports = __webpack_require__.p + "static/media/icomoon.f579f775.ttf";
...
"use strict";
module.exports = __webpack_require__.p + "static/media/icomoon.1de56a85.woff";
