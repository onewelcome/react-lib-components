  ...
  const getTextareaWrapper = () => {
    if (rest["data-readonlyview"]) {
      return /*#__PURE__*/react.createElement("div", {
        ...
        id: name,
        tabIndex: 0,
        className: "".concat(error ? TextareaWrapper_TextareaWrapper_module["error"] : "", " ").concat(success ? TextareaWrapper_TextareaWrapper_module["success"] : "")
      }, icon, value);
    }
