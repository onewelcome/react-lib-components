...
/* harmony export */   DatePickerRange: () => (/* binding */ DatePickerRange),
/* harmony export */   __namedExportsOrder: () => (/* binding */ __namedExportsOrder),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _src_components_DatePicker_DatePicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/components/DatePicker/DatePicker.tsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var _DatePicker_mdx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./stories/DatePicker/DatePicker.mdx");
...
const meta = {
  ...
  component: _src_components_DatePicker_DatePicker__WEBPACK_IMPORTED_MODULE_2__/* .DatePicker */ .l,
  parameters: {
    docs: {
      page: _DatePicker_mdx__WEBPACK_IMPORTED_MODULE_3__["default"],
      source: {
        type: "code"
      }
    }
...
const Template = args => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_src_components_DatePicker_DatePicker__WEBPACK_IMPORTED_MODULE_2__/* .DatePicker */ .l, _extends({}, args, {
  ...
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, inputValue === null || inputValue === void 0 ? void 0 : inputValue.toDateString()));
};
const DatePicker = Template.bind({});
DatePicker.play = (0,_storybook_conditionalPlay__WEBPACK_IMPORTED_MODULE_4__/* .conditionalPlay */ .h)(async _ref => {
  let {
    canvasElement
  } = _ref;
  const canvas = (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .within */ .ux)(canvasElement);
  await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .waitFor */ .fm)(() => {
    const datePicker = canvas.getByTestId("date-picker");
    (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(datePicker).toBeDefined();
  });
  const dayOfTheMonth = canvas.getByText("10");
  await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .waitFor */ .fm)(() => (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(dayOfTheMonth).toBeDefined());
  await _storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .userEvent */ .Q4.click(dayOfTheMonth);
  await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(dayOfTheMonth.parentElement).toHaveAttribute("data-selected", "true");
});
const TemplateRange = args => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_src_components_DatePicker_DatePicker__WEBPACK_IMPORTED_MODULE_2__/* .DatePicker */ .l, _extends({}, args, {
    ...
    defaultMonth: new Date(1994, 3)
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, inputValue === null || inputValue === void 0 || (_inputValue$from = inputValue.from) === null || _inputValue$from === void 0 ? void 0 : _inputValue$from.toDateString()), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, inputValue === null || inputValue === void 0 || (_inputValue$to = inputValue.to) === null || _inputValue$to === void 0 ? void 0 : _inputValue$to.toDateString()));
};
const DatePickerRange = TemplateRange.bind({});
DatePickerRange.play = (0,_storybook_conditionalPlay__WEBPACK_IMPORTED_MODULE_4__/* .conditionalPlay */ .h)(async _ref2 => {
  let {
    canvasElement
  } = _ref2;
  const canvas = (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .within */ .ux)(canvasElement);
  await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .waitFor */ .fm)(() => {
    ...
    (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(specifiedDate).toBeDefined();
  });
  await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .waitFor */ .fm)(async () => {
    const startingDay = canvas.getByText("15");
    const finishingDay = canvas.getByText("20");
    await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .waitFor */ .fm)(() => (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(startingDay).toBeDefined());
    await _storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .userEvent */ .Q4.click(startingDay);
    await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(startingDay.parentElement).toHaveAttribute("data-selected", "true");
    await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .waitFor */ .fm)(() => (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(finishingDay).toBeDefined());
    await _storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .userEvent */ .Q4.click(finishingDay);
    await (0,_storybook_test__WEBPACK_IMPORTED_MODULE_1__/* .expect */ .E3)(finishingDay.parentElement).toHaveAttribute("data-selected", "true");
  });
});
DatePicker.parameters = {
  ...DatePicker.parameters,
  docs: {
    ...DatePicker.parameters?.docs,
    source: {
      ...
      ...DatePicker.parameters?.docs?.source
    }
  }
};
