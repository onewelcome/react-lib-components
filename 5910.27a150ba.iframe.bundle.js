...
const BaseModalComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    ref: modalRef,
    id: id,
    className: `${BaseModal_BaseModal_module["modal"]} ${open ? BaseModal_BaseModal_module["visible"] : ""} ${className}`,
    role: "dialog",
    "aria-modal": "true",
    "aria-labelledby": labelledby ?? (0,BaseModalContext/* labelId */.o)(id),
    "aria-describedby": describedby ?? (0,BaseModalContext/* descriptionId */.I)(id),
    "aria-hidden": !open,
    tabIndex: -1,
    "data-hidden": !open,
  ...
  }), !hideBackdrop ? /*#__PURE__*/react.createElement("div", _extends({}, backdropProps, {
    "aria-hidden": true,
    className: `${BaseModal_BaseModal_module["backdrop"]} ${backdropProps?.className ?? ""}`,
    onClick: handleBackdropClick
  })) : null, forceContainerOpen ? /*#__PURE__*/react.createElement("div", _extends({}, containerProps, {
    "aria-hidden": !open,
    "data-element": "dialog",
    hidden: !open,
    style: {
    ...
    className: `${BaseModal_BaseModal_module["container"]} ${containerProps?.className ?? ""}`
...
try {
    ...
    // @ts-ignore
    BaseModal.__docgenInfo = { "description": "", "displayName": "BaseModal", "props": { "className": { "defaultValue": { value: "" }, "description": "", "name": "className", "required": false, "type": { "name": "string" } }, "id": { "defaultValue": null, "description": "", "name": "id", "required": true, "type": { "name": "string" } }, "domRoot": { "defaultValue": null, "description": "", "name": "domRoot", "required": false, "type": { "name": "HTMLElement" } }, "hideBackdrop": { "defaultValue": { value: "false" }, "description": "", "name": "hideBackdrop", "required": false, "type": { "name": "boolean" } }, "disableBackdrop": { "defaultValue": { value: "false" }, "description": "", "name": "disableBackdrop", "required": false, "type": { "name": "boolean" } }, "open": { "defaultValue": null, "description": "", "name": "open", "required": true, "type": { "name": "boolean" } }, "onClose": { "defaultValue": null, "description": "", "name": "onClose", "required": false, "type": { "name": "((event?: MouseEvent<HTMLElement, MouseEvent>) => unknown)" } }, "containerProps": { "defaultValue": null, "description": "", "name": "containerProps", "required": false, "type": { "name": "(Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, \"ref\"> & { ref?: ((instance: HTMLDivElement | null) => void) | ... 2 more ...; })" } }, "backdropProps": { "defaultValue": null, "description": "", "name": "backdropProps", "required": false, "type": { "name": "(Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, \"ref\"> & { ref?: ((instance: HTMLDivElement | null) => void) | ... 2 more ...; })" } }, "labelledby": { "defaultValue": null, "description": "", "name": "labelledby", "required": false, "type": { "name": "string" } }, "describedby": { "defaultValue": null, "description": "", "name": "describedby", "required": false, "type": { "name": "string" } }, "disableEscapeKeyDown": { "defaultValue": { value: "false" }, "description": "", "name": "disableEscapeKeyDown", "required": false, "type": { "name": "boolean" } }, "forceContainerOpen": { "defaultValue": { value: "false" }, "description": "", "name": "forceContainerOpen", "required": false, "type": { "name": "boolean" } }, "zIndex": { "defaultValue": null, "description": "", "name": "zIndex", "required": false, "type": { "name": "number" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
...
const BaseModalContentComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement("div", _extends({}, rest, {
    ref: ref ?? contentRef,
    id: id,
    className: `${BaseModalContent_BaseModalContent_module["content"]} ${className}`,
    tabIndex: -1
  }), children);
};
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.BaseModalContent-module__content--FW2Bc{padding:1.25rem 1.5rem 0;overflow-y:auto;flex:1;outline:none;font-size:var(--modal-content-font-size);line-height:1.43}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
