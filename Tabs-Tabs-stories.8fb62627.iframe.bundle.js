(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[6108],{
...
TabsWithFocusRing.play = (0,conditionalPlay/* conditionalPlay */.h)(async _ref => {
  ...
  await (0,testing_library_dist/* waitFor */.fm)(() => canvas.getByRole("tab", {
    name: "First tab"
  }));
  ...
  (0,jest_dist/* expect */.E)(tab1).toHaveAttribute("aria-selected", "true");
  await testing_library_dist/* userEvent */.Q4.click(tab2);
  (0,jest_dist/* expect */.E)(tab1).toHaveAttribute("aria-selected", "false");
  (0,jest_dist/* expect */.E)(tab2).toHaveAttribute("aria-selected", "true");
  await testing_library_dist/* userEvent */.Q4.click(tab3);
  (0,jest_dist/* expect */.E)(tab2).toHaveAttribute("aria-selected", "false");
  (0,jest_dist/* expect */.E)(tab3).toHaveAttribute("aria-selected", "true");
  await testing_library_dist/* userEvent */.Q4.click(tab1);
  (0,jest_dist/* expect */.E)(tab3).toHaveAttribute("aria-selected", "false");
});
