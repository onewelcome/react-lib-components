...
var WizardActions = function WizardActions(_ref) {
  ...
  var onPreviousWrapper = function onPreviousWrapper() {
    ...
    (_actions$previous$onC = (_actions$previous = actions.previous).onClick) === null || _actions$previous$onC === void 0 ? void 0 : _actions$previous$onC.call(_actions$previous);
