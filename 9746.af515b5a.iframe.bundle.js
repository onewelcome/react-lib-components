...
const useSearch = _ref => {
  ...
  const renderSearch = () => {
    return /*#__PURE__*/react.createElement("input", useSearch_extends({}, search?.searchInputProps ?? {}, {
      ref: searchInputRef,
      value: filter,
...
const MultiSelectComponent = (_ref, ref) => {
  ...
  const multiSelectId = (0,react.useRef)(id ?? (0,helper/* generateID */.ni)(20));
  ...
  const optionsElement = /*#__PURE__*/react.createElement("div", {
    className: `list-wrapper-container ${MultiSelect_module/* default */.A["list-wrapper-container"]}`
  }, /*#__PURE__*/react.createElement("div", {
    ref: optionListReference,
    className: `list-wrapper ${MultiSelect_module/* default */.A["list-wrapper"]}`,
    style: {
      display: expanded ? "block" : "none",
      opacity: opacity,
      maxHeight: optionsListMaxHeight.wrapper,
      pointerEvents: expanded ? "auto" : "none",
      top: listPosition === Select_interfaces/* Position */.y.Below ? "4px" : "initial",
      bottom: listPosition === Select_interfaces/* Position */.y.Above ? "4px" : "initial"
    }
  ...
  return /*#__PURE__*/react.createElement("div", {
    ref: myElementRef
  }, /*#__PURE__*/react.createElement("select", MultiSelect_extends({}, (0,helper/* filterProps */.J9)(rest, /^data-/, false), {
    tabIndex: -1,
    multiple: true,
    "aria-hidden": "true",
    ref: nativeSelect,
    ...
    className: `custom-select ${MultiSelect_module/* default */.A.select} ${additionalClasses.join(" ")}`
  }), listPosition === Select_interfaces/* Position */.y.Above ? optionsElement : undefined, /*#__PURE__*/react.createElement("div", {
    className: `${MultiSelect_module/* default */.A["custom-select"]} ${additionalClasses.join(" ")} `,
    style: {
      display: "flex"
    }
  }, /*#__PURE__*/react.createElement("div", {
    ...
    "aria-describedby": describedBy
  })), value?.length === 0 && placeholder && /*#__PURE__*/react.createElement("span", {
    className: MultiSelect_module/* default */.A["placeholder"]
  }, placeholder), value?.length > 0 && /*#__PURE__*/react.createElement(SelectedOptions, {
    disabled: disabled,
    display: display,
    onClick: onSelectButtonClick,
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.MultiSelect-module__select--mvCJ6{position:relative;box-sizing:border-box;border:0;border-radius:var(--input-border-radius);background-color:var(--input-background-color);font-size:var(--form-control-font-size);transition-property:all;transition-duration:.2s;transition-timing-function:ease-in-out}@media(prefers-reduced-motion: reduce){.MultiSelect-module__select--mvCJ6{transition-duration:.1ms}}.MultiSelect-module__select--mvCJ6 [data-display]{color:var(--color-default);font-family:var(--font-family)}.MultiSelect-module__select--mvCJ6.MultiSelect-module__expanded--kvYCi .MultiSelect-module__list-wrapper--Wx0ev{background:var(--light)}.MultiSelect-module__select--mvCJ6:not(.MultiSelect-module__expanded--kvYCi) .MultiSelect-module__custom-select--eaNQ4:focus:not(.MultiSelect-module__error--sFCnt){border:var(--input-border-width-focus) solid var(--color-focus);padding:0 calc(.5*var(--font-size) - var(--input-border-width-focus))}.MultiSelect-module__select--mvCJ6:hover:not(.MultiSelect-module__disabled--J7mc7):not(.MultiSelect-module__expanded--kvYCi):not(.MultiSelect-module__error--sFCnt) .MultiSelect-module__custom-select--eaNQ4:not(:focus){border-color:var(--default);border-width:var(--input-border-width);background-color:var(--color-blue-grey25)}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4{box-sizing:border-box;width:100%;min-height:calc(2.875*var(--font-size) - 2*var(--input-border-width));padding:0 calc(.5*var(--font-size) - var(--input-border-width));background-color:rgba(0,0,0,0);border-color:var(--color-blue-grey500);border-style:var(--input-border-style);border-width:var(--input-border-width);border-radius:var(--input-border-radius);font-size:var(--form-control-font-size);transition-property:all;transition-duration:.2s;transition-timing-function:ease-in-out}@media(prefers-reduced-motion: reduce){.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4{transition-duration:.1ms}}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4:focus{outline:0}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4.MultiSelect-module__error--sFCnt{border-color:var(--error)}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4.MultiSelect-module__error--sFCnt:focus{border-width:var(--input-border-width-focus)}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4.MultiSelect-module__disabled--J7mc7{border-color:var(--color-disabled);pointer-events:none}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4 .MultiSelect-module__display-container--_buwZ{flex:1;display:flex;align-items:center;padding:.1875rem 0;gap:.375rem}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__list-wrapper-container--QRA_j{position:relative}.MultiSelect-module__select--mvCJ6 .MultiSelect-module__list-wrapper--Wx0ev{border-color:var(--light-grey-border);border-style:var(--input-border-style);border-width:var(--input-border-width);border-radius:var(--input-border-radius);box-shadow:0px 4px 5px 0px rgba(1,5,50,.2);box-shadow:0px 3px 14px 0px rgba(1,5,50,.1215686275);box-shadow:0px 8px 10px 0px rgba(1,5,50,.1411764706);position:absolute;z-index:11;left:0;width:100%;overflow:auto}.MultiSelect-module__select--mvCJ6 ul{box-sizing:border-box;padding:.25rem 0;width:100%;margin:0;list-style:none;background-color:var(--light);border-radius:var(--input-border-radius);color:var(--default);text-align:left;overflow:auto;max-height:25rem}.MultiSelect-module__select--mvCJ6 ul li{padding:.62rem .75rem;font-size:var(--form-control-font-size);margin:0;position:relative;line-height:1.43;box-sizing:border-box;min-height:2.5rem;cursor:pointer}.MultiSelect-module__select--mvCJ6 ul li:after{content:"";position:absolute;top:0;left:0;background-color:rgba(0,0,0,0);width:100%;height:100%;opacity:.05}.MultiSelect-module__select--mvCJ6 ul li:focus,.MultiSelect-module__select--mvCJ6 ul li.MultiSelect-module__focus--zRndk{outline:none}.MultiSelect-module__select--mvCJ6 ul li:focus::before,.MultiSelect-module__select--mvCJ6 ul li.MultiSelect-module__focus--zRndk::before{content:"";position:absolute;top:0;left:.125rem;height:100%;width:calc(100% - .25rem);opacity:1;z-index:101;outline:calc(.125*var(--font-size)) solid var(--color-focus);outline-offset:0;border-radius:var(--focus-border-radius)}.MultiSelect-module__select--mvCJ6 ul li:hover:after,.MultiSelect-module__select--mvCJ6 ul li:active:after{background-color:var(--color-primary)}.MultiSelect-module__select--mvCJ6 ul li:active:after{opacity:.1}.MultiSelect-module__select--mvCJ6 ul li.MultiSelect-module__disabled--J7mc7{color:var(--greyed-out);background-color:var(--disabled);pointer-events:none}.MultiSelect-module__status--y_z2W{padding:.3125rem;display:flex;align-items:center}.MultiSelect-module__status--y_z2W [data-icon-status=success]{color:var(--success);font-size:var(--font-size-big)}.MultiSelect-module__status--y_z2W [data-icon-status=error]{color:var(--error);font-size:var(--font-size-big)}.MultiSelect-module__status--y_z2W .MultiSelect-module__chevron-icon--JsNoc{color:var(--default);font-size:var(--font-size-small)}.MultiSelect-module__status--y_z2W *+*{margin-left:1.25rem}.MultiSelect-module__placeholder--ZoPqi{color:var(--greyed-out)}.MultiSelect-module__select-search--imgo0{flex:1;box-sizing:border-box;border-bottom-left-radius:0;border-bottom-right-radius:0;border:0;background-color:rgba(0,0,0,0);color:var(--default);font-family:var(--font-family);font-size:calc(.83*var(--font-size));line-height:1.3333;margin:0;padding:0}.MultiSelect-module__select-search--imgo0:focus-visible,.MultiSelect-module__select-search--imgo0:focus{outline:none}.MultiSelect-module__disabled--J7mc7{cursor:not-allowed;color:var(--greyed-out);background-color:var(--color-blue-grey25)}.MultiSelect-module__disabled--J7mc7>*{pointer-events:none}@media only screen and (min-width: 30em){.MultiSelect-module__select--mvCJ6 .MultiSelect-module__custom-select--eaNQ4{padding:0 calc(.5*var(--font-size) - var(--input-border-width))}.MultiSelect-module__select--mvCJ6:not(.MultiSelect-module__expanded--kvYCi) .MultiSelect-module__custom-select--eaNQ4:focus:not(.MultiSelect-module__error--sFCnt){padding:0 calc(.5*var(--font-size) - var(--input-border-width-focus))}}[data-readonlyview=true] .MultiSelect-module__custom-select--eaNQ4{color:var(--read-only-text-color);border-color:var(--read-only-border-color);background-color:var(--color-white)}[data-readonlyview=true] .MultiSelect-module__custom-select--eaNQ4.MultiSelect-module__error--sFCnt,[data-readonlyview=true] .MultiSelect-module__custom-select--eaNQ4.MultiSelect-module__success--N8amC{border-color:var(--read-only-border-color)}[data-readonlyview=true] .MultiSelect-module__custom-select--eaNQ4 button{pointer-events:none}[data-readonlyview=true] .MultiSelect-module__status--y_z2W .MultiSelect-module__chevron-icon--JsNoc{visibility:hidden}[data-readonlyview=true]:hover:not(.MultiSelect-module__disabled--J7mc7):not(.MultiSelect-module__expanded--kvYCi):not(.MultiSelect-module__error--sFCnt) .MultiSelect-module__custom-select--eaNQ4:not(:focus){color:var(--read-only-text-color);border-color:var(--read-only-border-color);background-color:var(--color-white)}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	...
	"list-wrapper-container": `MultiSelect-module__list-wrapper-container--QRA_j`,
	...
	"success": `MultiSelect-module__success--N8amC`
};
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.SelectedOptions-module__options--_0Q5i{position:relative;display:flex;gap:.375rem;flex-wrap:wrap;cursor:pointer}.SelectedOptions-module__tag--Lvc02{cursor:text}.SelectedOptions-module__tag--Lvc02 .SelectedOptions-module__remove-btn--XqC9M{cursor:pointer}[data-readonlyview=true] .SelectedOptions-module__tag--Lvc02 .SelectedOptions-module__remove-btn--XqC9M{display:none}`, ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
