...
const SideSheetComponent = (_ref, ref) => {
  ...
  const handleTitle = (_handleButtonProps$ti = handleButtonProps === null || handleButtonProps === void 0 ? void 0 : handleButtonProps.title) !== null && _handleButtonProps$ti !== void 0 ? _handleButtonProps$ti : "Side sheet handle";
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, handleButtonProps && !open && /*#__PURE__*/react.createElement("div", {
    ...
    id: id,
    open: controlledOpen,
    className: "".concat(SideSheet_SideSheet_module["slide-in-modal"], " ").concat(open ? SideSheet_SideSheet_module["visible"] : "", " ").concat(!open ? SideSheet_SideSheet_module[classHideOnTransition] : ""),
    containerProps: {
...
const SideSheetHeader = _ref => {
  ...
  return /*#__PURE__*/react.createElement(BaseModalHeader/* BaseModalHeader */.O, SideSheetHeader_extends({}, rest, {
    className: "".concat(SideSheetHeader_SideSheetHeader_module["side-sheet-header"], " ").concat(className)
  }));
};
...
const SideSheetContent = _ref => {
  ...
  return /*#__PURE__*/react.createElement(BaseModalContent/* BaseModalContent */._, SideSheetContent_extends({}, rest, {
    className: "".concat(SideSheetContent_SideSheetContent_module["side-sheet-content"], " ").concat(className)
  }));
};
