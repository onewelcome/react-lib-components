...
function _createMdxContent(props) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_3__/* .Meta */ .W8, {
      ...
      id: "note-on-accessibilty",
      children: "Note on accessibilty"
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)(_components.p, {
      children: ["According to WCAG, all of the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "img"
      }), " elements should have an ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "alt"
      }), " attribute with descriptive text conveying the meaning of the image.\nYou can use the ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "imgAltText"
      }), " property to set that attribute on IdP icon. However, if no ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "imgAltText"
      }), " is provided, the icon will have ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "aria-hidden"
      }), " set to ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_components.code, {
        children: "true"
      }), ", making it hidden from assistive technologies such as screen readers."]
...
const IdentityProviderButton_IdentityProviderButton = _ref => {
  ...
  const generateCSSProperties = () => {
    return {
      ...
      "--button-primary-focused-color": customization?.focusBackgroundColor ?? DEFAULT_BACKGROUND_COLOR,
      "--button-primary-hover-color": customization?.hoverBackgroundColor ?? DEFAULT_HOVER_COLOR,
      "--button-primary-pressed-color": customization?.pressedBackgroundColor ?? DEFAULT_PRESSED_COLOR
    };
  };
 ...
 *    See the License for the specific language governing permissions and
 *    limitations under the License.
 */.IdentityProviderButton-module__idp-button--v4hWk{width:100%}.IdentityProviderButton-module__idp-button--with-icon--vWwtg{display:flex;align-items:center;justify-content:center;gap:.5rem;margin-top:-0.125rem;margin-bottom:-0.125rem}`, ""]);
// Exports
