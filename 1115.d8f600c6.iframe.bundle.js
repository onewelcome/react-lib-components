...
const TextareaWrapperComponent = (_ref, ref) => {
  ...
  const getTextareaWrapper = () => {
    if (rest["data-readonlyview"]) {
      return /*#__PURE__*/react.createElement("div", {
        ...
        id: name,
        tabIndex: 0,
        className: `${error ? TextareaWrapper_TextareaWrapper_module["error"] : ""} ${success ? TextareaWrapper_TextareaWrapper_module["success"] : ""}`
      }, icon, value);
    }
    return /*#__PURE__*/react.createElement(Textarea/* Textarea */.T, _extends({}, textareaProps, {
      error: error,
      "aria-labelledby": label && labelId,
      "aria-describedby": error ? errorId : helperId,
      ...
      className: `${TextareaWrapper_TextareaWrapper_module["textarea"]} ${error ? TextareaWrapper_TextareaWrapper_module["error"] : ""}`,
      wrapperProps: {
        className: `${wrapperClasses.join(" ")} ${TextareaWrapper_TextareaWrapper_module["textarea-wrapper"]}`
      }
    }));
  };
  return /*#__PURE__*/react.createElement(Wrapper/* Wrapper */.m, _extends({}, rest, {
    ...
    labelProps: {
      id: labelId,
      className: `${TextareaWrapper_TextareaWrapper_module["textarea-label"]} ${wrapperClasses.join(" ")}`
    },
    name: name,
    label: label,
    helperId: helperId,
...
const TextareaWrapper = (0,withReadOnly/* withReadOnly */.R)(/*#__PURE__*/react.forwardRef(TextareaWrapperComponent), {
