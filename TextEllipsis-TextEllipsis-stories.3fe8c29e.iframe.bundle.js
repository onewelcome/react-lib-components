...
var update = injectStylesIntoStyleTag_default()(TextEllipsis_module/* default */.Z, options);
       ...
       /* harmony default export */ const TextEllipsis_TextEllipsis_module = (TextEllipsis_module/* default */.Z && TextEllipsis_module/* default */.Z.locals ? TextEllipsis_module/* default */.Z.locals : undefined);
...
TextEllipsis_stories_TextEllipsis.play = (0,conditionalPlay/* conditionalPlay */.B)(async _ref => {
  let {
    canvasElement
  } = _ref;
  const canvas = (0,testing_library_dist/* within */.uh)(canvasElement);
  await (0,testing_library_dist/* waitFor */.X_)(() => (0,jest_dist/* expect */.l)(canvas.findAllByText("This is a long text that will trigger the ellipsis and show a popover.")).not.toBeNull());
  ...
  await testing_library_dist/* userEvent */.mV.hover(elementToHover);
  (0,jest_dist/* expect */.l)(strings[1]).not.toHaveAttribute("aria-hidden", "true");
});
