...
/* harmony export */   InputInReadOnlyMode: () => (/* binding */ InputInReadOnlyMode),
...
const InputInReadOnlyMode = Template.bind({});
...
InputInReadOnlyMode.parameters = {
  ...InputInReadOnlyMode.parameters,
  docs: {
    ...InputInReadOnlyMode.parameters?.docs,
    source: {
      originalSource: "args => {\n  return <Form onSubmit={() => {}}>\n      <InputComponent id=\"input-component\" {...args} />\n    </Form>;\n}",
      ...InputInReadOnlyMode.parameters?.docs?.source
    }
  }
};;const __namedExportsOrder = ["Input","InputInReadOnlyMode"];
