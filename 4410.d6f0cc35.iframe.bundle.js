(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[4410],{
...
const DialogTitleComponent = (_ref, ref) => {
  ...
  return /*#__PURE__*/react.createElement("div", DialogTitle_extends({}, rest, {
    ...
    className: `${DialogTitle_DialogTitle_module["headline"]} ${caption ? DialogTitle_DialogTitle_module["with-caption"] : DialogTitle_DialogTitle_module["no-caption"]}`
...
const DialogComponent = (_ref, ref) => {
  ...
  const [dialogId] = (0,react.useState)(id ?? (0,helper/* generateID */.ni)(20));
  const {
    label: primaryLabel,
    ...restOfPrimaryAction
  } = primaryAction;
