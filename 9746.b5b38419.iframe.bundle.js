...
const MultiSelectComponent = (_ref, ref) => {
  ...
  const optionsElement = /*#__PURE__*/react.createElement("div", {
    className: "list-wrapper-container ".concat(MultiSelect_module/* default */.A["list-wrapper-container"])
