"use strict";
(self["webpackChunk_onewelcome_react_lib_components"] = self["webpackChunk_onewelcome_react_lib_components"] || []).push([[830],{
...
const Template = args => {
  ...
  return /*#__PURE__*/react.createElement(Form/* Form */.l, {
  ...
  }, /*#__PURE__*/react.createElement(Fieldset/* Fieldset */.L, _extends({}, args, {
    legend: "Name"
    ...
    disabled: true,
    value: ""
  }, "Prefix"), /*#__PURE__*/react.createElement(Option/* Option */.c, {
    value: "mr"
  }, "Mr."), /*#__PURE__*/react.createElement(Option/* Option */.c, {
    value: "mrs"
  }, "Mrs.")), /*#__PURE__*/react.createElement(InputWrapper/* InputWrapper */.o, {
    onChange: event => setFirstName(event.target.value),
    label: "First name",
    errorMessage: "Error message",
    error: false,
    ...
    name: "last-name",
    type: "text"
  })), /*#__PURE__*/react.createElement(Button/* Button */.$, null, "Test")));
};
